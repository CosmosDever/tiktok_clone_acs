...
export const Action_bar: React.FC<ActionProps> = ({
  likeCount,
  commentCount,
  favoriteCount,
  shareCount,
  ...
  return (
    <div className="flex flex-col h-40 py-72">
      <button onClick={handleLikeClick} className="py-2">
        ...
        <strong className="border-none bg-none outline-none p-0 relative flex items-center cursor-pointer flex-col text-rgba font-TikTokFont font-sans text-xs leading-4 text-center">
          {likes}
        </strong>
      </button>
